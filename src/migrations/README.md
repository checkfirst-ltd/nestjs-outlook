...
2. `1699000000000-AddMicrosoftUserTable.ts` - Adds the Microsoft User table for improved token management
3. `1747823568806-CreateOutlookDeltaLinksTable` - Adds the Outlook Delta Links table to handle events synchronization

...
const outlookPackagePath = path.dirname(
  require.resolve("@checkfirst/nestjs-outlook/package.json")
);
...
export const databaseConfig: DataSourceOptions = {
  ...
  migrations: [
    ...
    // Outlook module migrations
    path.join(outlookPackagePath, "dist", "migrations", "*.js"),
  ],
